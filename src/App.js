  ...
  return (
    <motion.div initial='initial' animate='animate'>
      <motion.header variants={stagger}>
          <motion.div className="logo_wrapper" variants={header}>No<span>me.</span></motion.div>
      ...
      <motion.div className="content_wrapper" initial={{opacity:0,scale:0}} animate={{opacity:1, scale:1}} transition={{duration:0.3, ease:easeing}}>
        <div className="left_content_wrapper">
          ...
          <motion.div className="review_container" variants={stagger}>
            <motion.p className="total_review" variants={star}>64+ Avaliações</motion.p>
            ...
            <motion.p className="more_review" variants={star}>Mais de 50+ pessoas utilizando nossos serviços.</motion.p>
          </motion.div>
        </div>
